...
- **HD현대중공업 디지털혁신부 인턴**  
  `2025.09 ~ 2025.12` | C#을 활용한 사내 포털시스템 개발 및 Vue.js와 Spring Boot를 이용한 보온재 재고 관리 어플 개발
  
- **HD현대중공업 디지털혁신부 매니저(정규직)**  
  `2026.01 ~ ` | C#, Java, Spring Boot, Vue3, Oracle 등 사용, 현장 맞춤형 웹 및 모바일 어플 개발, 사내 포털시스템 개발 등
---
